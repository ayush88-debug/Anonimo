  ...
  return (
    ...
    <div className="w-full max-w-md p-8 space-y-8 bg-gray-900 rounded-2xl shadow-xl border border-gray-700">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold tracking-tight mb-4">Verify Your Account</h1>
        <p className="text-gray-400 text-sm">Enter the verification code sent to your email <br/>
